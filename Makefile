...
tb.exe: *.v
	iverilog -D PERIOD=20 -D CLK_DELAY=0.01 -D USE_RAM=1 -D ROMGEN=1 -D AW=9 -g2005-sv -f verilog.f -o tb.exe

counter.vcd: tb.exe
	./tb.exe

romgen: *.v
	iverilog -D PERIOD=20 -D CLK_DELAY=0.01 -D USE_RAM=1 -D TABLEGEN=1 -D AW=9 -g2005-sv -f verilog.f -o tb.exe
	./tb.exe
