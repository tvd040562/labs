...
set IO_DELAY [expr $::env(CLOCK_PERIOD) * 0.3]
...
set_input_delay $IO_DELAY -clock [get_clocks {clk}] -add_delay [get_ports {csb00 csb10 csb20 csb30}]
...
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {csb00 csb10 csb20 csb30}]
...
set_false_path --from [get_ports {reset pl_data[0]}] --to [get_clocks {clk}]
